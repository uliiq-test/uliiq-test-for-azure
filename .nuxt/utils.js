...
export async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      error: context.error,
      base: '/',
      env: {"GTAG_ID":"UA-DDDDDDD-DD","WEB_URL":"https://wishhub-dev.azurewebsites.net","INSTANCE":"03bbf694-dd56-4ef4-bec1-8b6b0098c1cf","CLIENT_ID":"https://login.microsoftonline.com/tfp/","DOMAIN":"wishhub.onmicrosoft.com","SIGN_UP_SIGN_IN_POLICY_ID":"B2C_1_wishhub_dev","API_URL":"https://wishhub-dev.azurewebsites.net"}
    }
    // Only set once
