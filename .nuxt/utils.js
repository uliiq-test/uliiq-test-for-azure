...
export async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      error: context.error,
      base: '/',
      env: {"GTAG_ID":"UA-138682818-1","WEB_URL":"https://wishhub.fan","INSTANCE":"8b7ad74b-b66d-4bd7-b5ab-84a8c9afb619","CLIENT_ID":"https://login.microsoftonline.com/tfp","DOMAIN":"wishhub.onmicrosoft.com","SIGN_UP_SIGN_IN_POLICY_ID":"B2C_1_WishHub","API_URL":"https://api.wishhub.fan","FB_APP_ID":"2342903979136724"}
    }
    // Only set once
